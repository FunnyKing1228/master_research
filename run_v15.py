"""V15 training launcher — run this file directly: py -u run_v15.py"""
import os, sys, time
...
CFG_PATH = os.path.join(ROOT, 'configs', 'experiments', 'p302', 'config_p302_v15.yaml')

print("=" * 60)
print("  P302 SLFB — V15 Training (1A rated current)")
print("=" * 60)
...
exp_manager = create_experiment_from_config(CFG_PATH, experiment_name="sac_v15_1A")
